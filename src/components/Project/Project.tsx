      ...
      <div className="projects">
          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Souvikparua/Online_Exam_System" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>A web-based platform for conducting online examinations with automated evaluation and real-time monitoring</h3>
              <p> Developed a comprehensive Online Exam System Using DeepSeek AI For a Coaching Institute aimed at providing a robust, user-friendly, and secure platform for conducting exams online. The system addresses challenges faced in traditional paper-based examinations and offers an efficient examination process for educational institutions(MySQL, Php, Css, Html,Xampp) </p>
            </div>
            <footer> <ul className="tech-list"> <li>PHP</li> <li>My SQL</li> <li>Xampp</li> <li>HTML</li> <li>CSS</li></ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/Souvikparua/Langchain-App" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
                <a href="#" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>A Langchain app that allows you to chat with multiple PDFs</h3>
              <p>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Souvikparua/Urban-Traffic-Management-for-Safer-Cities" target="\_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>Revolutionizing Urban Traffic Management for Safer Cities</h3>
              <p>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Souvikparua/CarePulse" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="#" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
            ...
            <div className="body">
              <h3>CarePulse: is an innovative healthcare management system</h3>
              <p>CarePulse is an innovative healthcare management system designed to streamline patient care, enhance communication between healthcare providers, and improve overall healthcare outcomes. This project leverages cutting-edge technologies to deliver a robust and user-friendly platform.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>TypeScript</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Souvikparua/Smart-Bengal-Hackathon-Farm-App" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="#" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
            ...
            <div className="body">
              <h3>Crop Disease Detection and Recommendation Web application</h3>
              <p>Crop Disease Detection App Imagine having a crop doctor in your pocket! These apps use your phone's camera to analyze photos of your plants and diagnose diseases. They leverage powerful image recognition technology, often powered by AI, to identify hundreds of different crop diseases and pests.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>Python</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          ...
          <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Souvikparua/Azure-Data-Factory-Self-Hosted-Integration-Runtime" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="#" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
            ...
            <div className="body">
              <h3>Azure Data Factory self-hosted integration runtime on App Service</h3>
              <p>
              self-hosted integration runtime to extract data from a local server and load it into an Azure database, configure an FTP/SFTP server with an ADF pipeline for data extraction, create and automate a daily incremental load pipeline, and schedule a pipeline to trigger every last Saturday of the month.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
